...
class V_principal(CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.geometry("960x540")  # Geometría a libre albedrío
        ...
        # Widgets marco 1
        ##Entrada de usuario
        self.e_usuario = CTkEntry(self.marco1,font=("sans rerif", 14), bg_color=c1, fg_color= c1, text_color=c4, placeholder_text="Ingresar usuario", border_color=c4)
        self.e_usuario.grid(columnspan=2, row=1, padx=4, pady=4) # Se va a colocar en la primera fila

        ##Boton para ingresar
        self.b_ingresar_usuario = CTkButton(self.marco1, bg_color=c1, fg_color=c4, text_color=c1, text="Buscar usuario", border_color=c4)
        self.b_ingresar_usuario.grid(columnspan=2, row=2, padx=4, pady=4)
        ...
        self.b_crear_usuario.grid(columnspan=2, row=3, padx=4, pady=4)
